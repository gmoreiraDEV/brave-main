...
export default function Hero() {
    return (
        <section className="w-screen h-full bg-bg-hero bg-cover bg-no-repeat bg-center flex flex-col items-center justify-start lg:justify-center py-10">
            <div className="w-full p-6 lg:w-2/3 text-brand-off-white text-center ">
            ...
            <div className="flex md:flex-row flex-col justify-center items-center gap-12 mb-28">
